...
#ifndef VISIONCORE_ROAD_LANEOUTPUT_TYPES_INCLUDED
#define VISIONCORE_ROAD_LANEOUTPUT_TYPES_INCLUDED
...
/* Struct definitions */
typedef struct _VisionCore_Road_Clothoid_Raw {
    /** LateralDistance
...
typedef struct _VisionCore_Road_Clothoid {
     ...
     * Max: 0.032767
     */
    float curvatureRateSecondClothoid;
    /** SecondClothoidActive
     * Indicates if second clothoid is used
     */
    bool secondClothoidActive;
...
typedef struct _VisionCore_Road_ClothoidVariance_Raw {
...
} VisionCore_Road_ClothoidVariance_Raw;
...
typedef struct _VisionCore_Road_ClothoidVariance {
     ...
     * Max: 0.032767
     */
    float curvatureRateSecondClothoidVariance;
} VisionCore_Road_ClothoidVariance;

typedef struct _VisionCore_Road_LaneEvent_Raw {
    /** Id
...
typedef struct _VisionCore_Road_TemporaryMarkings_Raw {
    /** Type
...
} VisionCore_Road_TemporaryMarkings_Raw;
...
typedef struct _VisionCore_Road_LaneTrack_Raw {
    /** Valid
     ...
     */
    VisionCore_Road_Clothoid_Raw clothoid;
    /** IsSafe
     ...
     */
    VisionCore_Road_ClothoidVariance_Raw clothoidVariance;
} VisionCore_Road_LaneTrack_Raw;
...
typedef struct _VisionCore_Road_LaneTrack {
     ...
     * Max: 2.55
     */
    float distanceFirstToSecondMarking;
    /** Clothoid
     * Describes lane marking clothoid
     */
...
typedef struct _VisionCore_Road_EgoLane_Raw {
    /** Left
     * Left ego lane boundary
     */
    VisionCore_Road_LaneTrack_Raw left;
    /** Right
     * Right ego lane boundary
     */
    VisionCore_Road_LaneTrack_Raw right;
    /** ParallelDistance
...
typedef struct _VisionCore_Road_LaneOutput_Raw {
    /** EgoLane
     * The ego lane
     */
    VisionCore_Road_EgoLane_Raw egoLane;
    /** CoupledEgoLane
     * The coupled ego lane
     */
    VisionCore_Road_EgoLane_Raw coupledEgoLane;
    /** NeighborLeft
     * Left neighbor lane boundary
     */
    VisionCore_Road_LaneTrack_Raw neighborLeft;
    /** NeighborRight
     * Right neighbor lane boundary
     */
    VisionCore_Road_LaneTrack_Raw neighborRight;
    qpb_size_t events_count;
    /** Events
     * Describes the current lane events
     */
    VisionCore_Road_LaneEvent_Raw events[4];
    /** TemporaryMarkings
     * Describes temporary markings
     */
    VisionCore_Road_TemporaryMarkings_Raw temporaryMarkings;
    /** SideSuggestion
...
} VisionCore_Road_LaneOutput_Raw;
...
#endif /* VISIONCORE_ROAD_LANEOUTPUT_TYPES_INCLUDED */
