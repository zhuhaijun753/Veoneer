...
#ifndef RADARCORE_TRACKS_STATIONARYTRACKS_TYPES_INCLUDED
#define RADARCORE_TRACKS_STATIONARYTRACKS_TYPES_INCLUDED
...
/* Struct definitions */
typedef struct _RadarCore_Tracks_StationaryTrackMovement_Raw {
    /** XVelocity
     ...
     */
    int32_t yVelocity;
} RadarCore_Tracks_StationaryTrackMovement_Raw;
...
typedef struct _RadarCore_Tracks_StationaryTrackPosition_Raw {
    /** X
     * Filtered X position
     * Unit: m
     * Scale: 0.01
     ...
     */
    int32_t y;
} RadarCore_Tracks_StationaryTrackPosition_Raw;
...
typedef struct _RadarCore_Tracks_StationaryTrack_Raw {
    /** Id
     ...
     */
    RadarCore_Tracks_StationaryTrackPosition_Raw position;
    /** Movement
     * Movement estimation of object
     */
    RadarCore_Tracks_StationaryTrackMovement_Raw movement;
    /** Lifetime
...
} RadarCore_Tracks_StationaryTrack_Raw;
...
typedef struct _RadarCore_Tracks_StationaryTrackList_Raw {
    qpb_size_t tracks_count;
    /** Tracks
     * List of stationary tracks
     */
    RadarCore_Tracks_StationaryTrack_Raw tracks[40];
} RadarCore_Tracks_StationaryTrackList_Raw;
...
#endif /* RADARCORE_TRACKS_STATIONARYTRACKS_TYPES_INCLUDED */
