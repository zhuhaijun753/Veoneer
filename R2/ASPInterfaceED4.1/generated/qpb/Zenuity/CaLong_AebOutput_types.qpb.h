...
#ifndef ZENUITY_CALONG_AEBOUTPUT_TYPES_INCLUDED
#define ZENUITY_CALONG_AEBOUTPUT_TYPES_INCLUDED
...
/* Struct definitions */
typedef struct _Zenuity_CaLong_AebRequest_Raw {
    /** DecelerationEnabled
...
typedef struct _Zenuity_CaLong_AebRequest {
     ...
     * Max: 13
     */
    float avoidanceDeceleration;
} Zenuity_CaLong_AebRequest;

typedef struct _Zenuity_CaLong_CollisionForwardWarningControl_Raw {
    /** WarningRequest
     ...
     */
    VisionCore_Common_Coord2_m_0_01_Raw objectPosition;
    /** BrakePulseRequest
...
} Zenuity_CaLong_CollisionForwardWarningControl_Raw;
...
typedef struct _Zenuity_CaLong_CollisionForwardWarningControl {
     ...
     * Max: 25.5
     */
    float brakeGainMaxDeceleration;
    /** TimeToCollision
     * Time to collision for primary target. Set to 100s if no value is available.
     * Unit: s
     * Resolution: 0.01
...
typedef struct _Zenuity_CaLong_CollisionMitigationBrakeRequest_Raw {
    /** DecelerationEnabled
...
} Zenuity_CaLong_CollisionMitigationBrakeRequest_Raw;
...
typedef struct _Zenuity_CaLong_StaticDistanceWarningOutput_Raw {
    /** WarningRequest
     ...
     */
    uint8_t timeGap;
} Zenuity_CaLong_StaticDistanceWarningOutput_Raw;
...
typedef struct _Zenuity_CaLong_TimeToThreat_Raw {
    /** BrakeThreat
...
} Zenuity_CaLong_TimeToThreat_Raw;
...
typedef struct _Zenuity_CaLong_TimeToThreat {
     ...
     * Max: 5
     */
    float steeringThreat;
} Zenuity_CaLong_TimeToThreat;

typedef struct _Zenuity_CaLong_VruAebOutput_Raw {
    /** PrimaryTargetZone
     ...
     */
    uint8_t avoidanceDeceleration;
} Zenuity_CaLong_VruAebOutput_Raw;
...
typedef struct _Zenuity_CaLong_CollisionMitigationThreatInformation_Raw {
    /** BeltActivationLevel
     ...
     */
    Zenuity_CaLong_TimeToThreat_Raw timeToBrake;
    /** RawRequest
     * Raw AEB request and the deceleration request for avoiding the primary target.
     */
    Zenuity_CaLong_AebRequest_Raw rawRequest;
    /** ObjectId
     ...
     */
    uint16_t timeToCollision;
} Zenuity_CaLong_CollisionMitigationThreatInformation_Raw;
...
typedef struct _Zenuity_CaLong_CollisionMitigationSystem_Raw {
    /** ForwardWarningControl
     * Examples of driver alerts are audio, visual and haptic (brake pulse) warning
     */
    Zenuity_CaLong_CollisionForwardWarningControl_Raw forwardWarningControl;
    /** ThreatInformation */
    Zenuity_CaLong_CollisionMitigationThreatInformation_Raw threatInformation;
} Zenuity_CaLong_CollisionMitigationSystem_Raw;
...
#endif /* ZENUITY_CALONG_AEBOUTPUT_TYPES_INCLUDED */
