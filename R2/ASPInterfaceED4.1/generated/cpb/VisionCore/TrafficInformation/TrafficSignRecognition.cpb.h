...
#define VisionCore_TrafficInformation_ValidatedSign_size                                 ((30 + VisionCore_TrafficInformation_Sign_size + VisionCore_Common_Coord3_m_0_01_size + VisionCore_Common_Size2_m_0_01_size) + PB_VARINT_MAX_ENCODED_SIZE)
#define VisionCore_TrafficInformation_ValidatedSignList_size                             ((1282 + VisionCore_TrafficInformation_StateInfo_size) + PB_VARINT_MAX_ENCODED_SIZE)
...
/* Struct definitions */
typedef struct _VisionCore_TrafficInformation_AddOnSign {
    /** Type
     ...
     */
    uint8_t confidence;
} VisionCore_TrafficInformation_AddOnSign;

typedef struct _VisionCore_TrafficInformation_Sign {
    /** Category
     ...
     */
    uint8_t confidence;
} VisionCore_TrafficInformation_Sign;

typedef struct _VisionCore_TrafficInformation_StateInfo {
    /** Availability
     * Availability of TSR
     */
...
} VisionCore_TrafficInformation_StateInfo;
...
extern const pb_field_t VisionCore_TrafficInformation_StateInfo_fields[3];
extern const pb_field_t VisionCore_TrafficInformation_Sign_fields[14];
extern const pb_field_t VisionCore_TrafficInformation_AddOnSign_fields[3];
extern const pb_field_t VisionCore_TrafficInformation_ValidatedSign_fields[8];
extern const pb_field_t VisionCore_TrafficInformation_ValidatedSignList_fields[3];
#ifdef __cplusplus
} /* extern "C" */
#endif
